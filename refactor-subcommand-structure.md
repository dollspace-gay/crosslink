...
**6. Dispatch refactor (crosslink/src/main.rs, lines 1252-1792)**
...
Commands:
  ...
  mc            Mission control
  migrate-*     Schema migration (3 commands)
```

**~28 visible top-level commands** (down from 44). Hidden shortcuts and aliases add ~10 more that work but don't clutter help.

### Files modified

| File | Change |
|------|--------|
| `crosslink/src/main.rs` | New `IssueCommands` and `TimerCommands` enums, alias variants, dispatch refactor |
